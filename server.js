...
app.use(cors({ origin: "http://localhost:3000", credentials: true })); // Adjust the origin as necessary
...
const OperationalAdmin = mongoose.model(
    "OperationalAdmin",
    operationalAdminSchema
);
